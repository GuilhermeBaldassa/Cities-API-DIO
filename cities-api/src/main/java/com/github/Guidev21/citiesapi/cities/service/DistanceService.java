package com.github.Guidev21.citiesapi.cities.service;
...
import com.github.Guidev21.citiesapi.cities.entities.City;
import com.github.Guidev21.citiesapi.cities.repository.CityRepository;
import com.github.Guidev21.citiesapi.utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceUsingPoints(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        java.awt.Point p1 = cities.get(0).getLocation();
        java.awt.Point p2 = cities.get(1).getLocation();
